...
<body>	
	...
	<div id="topbar">
		<div id="topnav">
			<a id="active" href="#products">Availables</a>
	...
	<div class="container">
		...
		<div class="col-md-4">
			<form method="post" action="Products.php?action=add&id=<?php echo $row["item_id"]; ?>">
				<div style="border:0.5px solid ; background-color:transperant; border-radius:5px; padding:5px;" align="center">
					<div class="card_img">
						<img src="images/<?php echo $row["item_image"]; ?>" class="card_img" height="25px" /><br />
					</div>

					<div class="card_details" style ="width: 18rem;">
